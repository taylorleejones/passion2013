...
<div class="field">Live HLS (Playlist URL)<br><?php echo form_input("live_smil_mobile", set_value("live_smil_mobile")); ?></div>
<div class="field">Archive HLS (Playlist URL)<br><?php echo form_input("archive_smil_mobile", set_value("archive_smil_mobile")); ?></div>
