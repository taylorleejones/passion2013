...
<div class="field">Live SMIL (Mobile)<br><?php echo form_input("live_smil_mobile", set_value("live_smil_mobile")); ?></div>
<div class="field">Archive SMIL (Mobile)<br><?php echo form_input("archive_smil_mobile", set_value("archive_smil_mobile")); ?></div>
